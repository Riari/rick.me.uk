...
More recently, unrelated to this project, I started exploring <ExtLink url="https://ziglang.org/">Zig</ExtLink>--a language I had been meaning to try out for the past year or so. I didn't know much about Zig other than it being another attempt at "C, but better", so I was pleasantly surprised to learn that it has a drop-in C and C++ compiler and an elegant build system that uses Zig rather than some obscure DSL.
