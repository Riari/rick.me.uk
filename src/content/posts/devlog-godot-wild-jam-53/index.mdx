...
<ExternalLink url="https://godotwildjam.com/" label="Godot Wild Jam" /> is a monthly game jam centred around building games in the <ExternalLink url="https://godotengine.org/">Godot game engine</ExternalLink>. It starts on the second Friday of each month and lasts for nine days.
...
The game is <ExternalLink url="https://riari89.itch.io/train-blazer">hosted on itch.io</ExternalLink> if you'd like to try it, and the source is available on GitHub at https://github.com/Riari/gwj-jan-2023. Thanks for reading!