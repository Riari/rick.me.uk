...
I've been wanting to try <ExtLink url="https://odin-lang.org/">Odin</ExtLink> for a while now and decided it's the language I'll use for this year's _Advent of Code_ event.

<Alert type="info">
For those unfamiliar, <ExtLink url="https://adventofcode.com/">Advent of Code</ExtLink> is a Christmas-themed annual event consisting of an advent calendar of programming puzzles. Each day, from the 1st of December to the 25th (inclusive), a puzzle is unlocked. Each puzzle consists of two parts, each requiring an answer. One star is earned per correct answer.
...
First up were the <ExtLink url="https://code.visualstudio.com/docs/editor/tasks">tasks</ExtLink>. I wanted to be able to do three things with these:
...
Next, the <ExtLink url="https://code.visualstudio.com/docs/editor/debugging#_launch-configurations">launch configurations</ExtLink>. I just needed two—one for debugging a solution, and another for debugging its tests.
...
<Alert type="tip">
The `lldb` configuration type is provided by the <ExtLink url="https://marketplace.visualstudio.com/items?itemName=vadimcn.vscode-lldb">CodeLLDB</ExtLink> extension and the `cppvsdbg` type is provided by the <ExtLink url="https://marketplace.visualstudio.com/items?itemName=ms-vscode.cpptools">C/C++</ExtLink> extension.
</Alert>
