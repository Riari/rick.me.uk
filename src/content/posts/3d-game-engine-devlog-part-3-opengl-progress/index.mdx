...
At this point, for the most part, I'm back to following <ExternalLink url="https://learnopengl.com/" label="LearnOpenGL" />—and I'm not going to reiterate in detail any of the topics already covered there. If you want to know more about the topics mentioned in this post, I encourage you to read through the corresponding material on that site!
...
I created a basic implementation of this system by following <ExternalLink url="https://learnopengl.com/Lighting/Materials" label="LearnOpenGL's chapter on Materials" />. The first step was to define a basic new `Material` component consisting of the following properties:
...
<Image src={basicMaterialsImage.src} alt="Basic materials" />
...
Further following <ExternalLink url="https://learnopengl.com/Lighting/Materials" label="LearnOpenGL's chapter on lighting maps" /> (texture mapping), I implemented three types of texture map that replace all of the above properties barring `shininess`:
...
<Image src={textureMapsImage.src} alt="Texture maps" caption="Left to right: Diffuse, Specular, Emission" />
...
A small change, but a significant improvement. Potential next steps in this area could include further rearranging things for better compatibility with <ExternalLink url="https://www.youtube.com/watch?v=Th4huqR77rI" label="batch rendering" />, or introducing caching for the shader programs.
