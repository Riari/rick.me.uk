...
For the state object that carries state between phases, I integrated <ExternalLink url="https://github.com/adbario/php-dot-notation" label="adbario/php-dot-notation" />. This was a quick and easy way to get the idea across, but it probably wouldn't hold up well in a real project where you could be juggling lots of data on the lead-up to generating a response.
