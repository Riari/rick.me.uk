...
<Image src={photo1Image.src} alt="Photo of front - touchscreen" caption="Front - touchscreen" />

<Image src={photo2Image.src} alt="Photo of top - IR camera mounted in the top right" caption="Top - IR camera mounted in the top right" />

On the software side, he started with <ExternalLink url="https://github.com/tomshaffner/PiThermalCam" label="https://github.com/tomshaffner/PiThermalCam" />, a Python package providing viewing capabilities on Pis with the MLX90640. It provides two modes of operation:
...
It's a great project, which you can read more about in much more detail in a post written by the author <ExternalLink url="https://tomshaffner.github.io/PiThermalCam/" label="here" />.
...
<Image src={photo3Image.src} alt="Photo of display with camera feed" caption="Display with camera feed" />

<Image src={snapshotImage.src} alt="Snapshot saved on device" caption="Snapshot saved on the device" />
