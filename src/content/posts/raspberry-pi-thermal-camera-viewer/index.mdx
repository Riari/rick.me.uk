...
On the software side, he started with <ExtLink url="https://github.com/tomshaffner/PiThermalCam">{"https://github.com/tomshaffner/PiThermalCam"}</ExtLink>, a Python package providing viewing capabilities on Pis with the MLX90640. It provides two modes of operation:
...
It's a great project, which you can read more about in much more detail in a post written by the author <ExtLink url="https://tomshaffner.github.io/PiThermalCam/">here</ExtLink>.
...
*If you'd like to see the code for this project, you can find it at <ExtLink url="https://github.com/Riari/pi-thermal-cam">{"https://github.com/Riari/pi-thermal-cam"}</ExtLink>*