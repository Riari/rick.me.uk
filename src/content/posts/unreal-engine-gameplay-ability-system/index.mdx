...
* <ExternalLink url="https://github.com/tranek/GASDocumentation">tranek/GASDocumentation</ExternalLink> is a long-established, ongoing effort to understandand GAS and document it in detail. It's an excellent resource that is endorsed by Epic in the official docs.
