...
Unlike many other action RPGs, physics plays a major role in Roombageddon. Enemies have collision, and most abilities have varying degrees of knockback strength, leading to fun ways in which to collide with enemies and push them around.

My contributions spanned programming, game design, art, and audio. Highlights include:
...
You can play or download the game on <ExtLink url="https://riari89.itch.io/roombageddon">itch.io</ExtLink>.
