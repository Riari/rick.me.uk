...
type: "Tool"
weight: 30
headerImage: "../../../assets/project-headers/hex-map-editor.jpg"
...
* `HexagonalMapEditorWindow`: An `EditorWindow` implementation using the <ExtLink url="https://docs.unity3d.com/Packages/com.unity.addressables@2.6/manual/index.html">Addressables</ExtLink> package for grouping, listing, and selecting prefabs to place in the currently selected cell

The source code is available at <ExtLink url="https://github.com/Riari/unity-hex-map-editor">github.com/Riari/unity-hex-map-editor</ExtLink>.
...
_The tile assets I used in this project are from <ExtLink url="https://lauwet.itch.io/dice-lands-hexagon-tile-assets">itch.io/dice-lands-hexagon-tile-assets</ExtLink>._
