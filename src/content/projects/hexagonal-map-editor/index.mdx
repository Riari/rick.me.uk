...
I developed this hexagonal map editor in Unity 6 partly as an exploration into how hexagonal maps work in games like the Civilization series, but also to become more familiar with authoring custom tools in Unity.
...
<Video src={editorDemoVideo}></Video>
