...
status: "Active"
weight: 20
heroImage: "../../images/project-headers/unreal-action-rpg.jpg"
...
Currently, it consists of a player character, a mob type with rudimentary AI, movement and melee animations, player health, HUD, and sound effects (combat and ambient).

You can find the source code (as well as a roadmap with systems and features I'm interested in adding) at <ExternalLink url="https://github.com/Riari/unreal-arpg">Riari/unreal-arpg</ExternalLink>.

Here's how it looks in action:

<div class="video-container">
    <YouTube id="eMOvtCQe61s" />
</div>
...
* Models and animations from https://www.mixamo.com/